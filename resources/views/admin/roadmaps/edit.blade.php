                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header bg-info text-white">
                                <div class="card-title font-weight-bold">edit un roadmaps</div>
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{route('admin.roadmaps.update',$roadmap->id)}}" >
                                    @method('put')
                                    @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            ...
                                            <input id="name" name="name" type="text" value="{{@old('name',$roadmap->name)}}" class="form-control" placeholder="Code"/>
                                            @error('name')
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            ...
                                            <select id="circuit_id" name="circuit_id" type="text" class="custom-select">
                                                @foreach($cs as $d)
                                                    <option value="{{$d->id}}" {{old('circuit_id',$roadmap->circuit_id) === $d->id ? 'selected' : ''}}>
                                                        {{$d->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('circuit_id')
