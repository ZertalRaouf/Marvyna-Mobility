            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.subscriptions.index')}}" class="text-info">Abonnements</a></li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-between mb-3">
                                    <div class="col-md-auto text-center">
                                        <a href="{{route('admin.subscriptions.create')}}" class="btn btn-info rounded-circle elevation-1"><i class="fas fa-plus"></i></a>
...
{{--                                        <a href="javascript:void(0)" class="btn btn-info rounded-circle elevation-1"><i class="fas fa-file-upload"></i></a>--}}
                                        <a href="{{route('admin.subscriptions.export')}}" class="btn btn-info rounded-circle elevation-1"><i class="fas fa-file-download"></i></a>
                                    </div>
                                ...
                                <table id="table" class="table mt-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-capitalize">{{$subscription->user->name}}</td>
                                        ...
                                        <td class="text-white align-middle">
                                            <a class="btn btn-info rounded-circle btn-sm" href="{{route('admin.subscriptions.show',$subscription->id)}}">
                                                <i class="fas fa-folder"></i>
                                            </a>
                                            <a class="btn btn-info rounded-circle btn-sm" href="{{route('admin.subscriptions.edit',$subscription->id)}}">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a class="btn btn-info rounded-circle btn-sm" onclick="deleteForm({{$subscription->id}})">
