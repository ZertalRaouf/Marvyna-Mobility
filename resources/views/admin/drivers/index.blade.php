                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <div class="card-title font-weight-bold"><i class="fas fa-list mr-2"></i>Liste des chauffeurs</div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-between mb-3">
                                    <div class="col-md-auto text-center">
                                        <a href="{{route('admin.drivers.create')}}" class="btn btn-info rounded-circle elevation-1"><i class="fas fa-plus"></i></a>
...
{{--                                        <a href="javascript:void(0)" class="btn btn-info rounded-circle elevation-1"><i class="fas fa-file-upload"></i></a>--}}
                                        <a href="{{route('admin.drivers.export')}}" class="btn btn-info rounded-circle elevation-1"><i class="fas fa-file-download"></i></a>
                                    </div>
                                ...
                                <table id="table" class="table mt-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-white align-middle">
                                            ...
                                            <a class="btn btn-info rounded-circle btn-sm" href="{{route('admin.drivers.edit',$driver->id)}}">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a class="btn btn-info rounded-circle btn-sm" onclick="deleteForm({{$driver->id}})">
...
@push('js')
    ...
    <script>
        ...
        function deleteForm(id){
            Swal.fire({
                title: 'Êtes vous sûrs de vouloir supprimer ce chauffeur ?',
        ...
        const createForm = id => {
            ...
            f.setAttribute('action',`drivers/${id}`);
