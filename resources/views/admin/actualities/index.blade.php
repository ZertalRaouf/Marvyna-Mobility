                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <div class="card-title font-weight-bold"><i class="fas fa-list mr-2"></i>Liste des actualités</div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-between mb-3">
                                    <div class="col-md-auto text-center">
                                        <a href="{{route('admin.actualities.create')}}" class="btn btn-info rounded-circle elevation-1"><i class="fas fa-plus"></i></a>
                                    ...
                                    <div class="col-lg-3 mt-4 mt-lg-0">
                                        <form>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="actuality_search" value="{{request()->get('actuality_search')}}" placeholder="Recherche">
                                ...
                                <table id="table" class="table mt-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-capitalize">{{$actuality->title}}</td>
                                        ...
                                        <td class="align-middle">{{$actuality->created_at->format('d-m-Y')}}</td>
                                        <td class="text-white align-middle">
                                            <a class="btn btn-info rounded-circle btn-sm" href="{{route('admin.actualities.show',$actuality->id)}}">
                                                <i class="fas fa-folder"></i>
                                            </a>
                                            <a class="btn btn-info rounded-circle btn-sm" href="{{route('admin.actualities.edit',$actuality->id)}}">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a class="btn btn-info rounded-circle btn-sm" onclick="deleteForm({{$actuality->id}})">
...
@push('js')
    ...
    <script>
        ...
        const createForm = id => {
            ...
            f.setAttribute('action',`actualities/${id}`);
