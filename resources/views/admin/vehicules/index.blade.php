                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <div class="card-title font-weight-bold"><i class="fas fa-list mr-2"></i>Liste des véhicules</div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-between mb-3">
                                    <div class="col-md-auto text-center">
                                        <a href="{{route('admin.vehicules.create')}}" class="btn btn-info rounded-circle elevation-1"><i class="fas fa-plus"></i></a>
                                ...
                                <table id="table" class="table mt-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-white align-middle">
                                            <a class="btn btn-info rounded-circle btn-sm" href="{{route('admin.users.show',$vehicule->id)}}">
                                                <i class="fas fa-folder"></i>
                                            </a>
                                            <a class="btn btn-info rounded-circle btn-sm" href="{{route('admin.users.edit',$vehicule->id)}}">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a class="btn btn-info rounded-circle btn-sm" onclick="deleteForm({{$vehicule->id}})">
...
@push('js')
    ...
    <script>
        ...
        const createForm = id => {
            ...
            f.setAttribute('action',`vehicules/${id}`);
