                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <div class="card-title font-weight-bold"><i class="fas fa-list mr-2"></i>Liste des circuits</div>
                                    ...
                                    <div class="col-lg-3 mt-4 mt-lg-0">
                                        <form>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="circuit_search" value="{{request()->get('circuit_search')}}" placeholder="Recherche">
                                ...
                                <table id="table" class="table mt-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-white align-middle">
                                            ...
                                            <a class="btn btn-info rounded-circle btn-sm" onclick="deleteForm({{$c->id}})">
...
@push('js')
    ...
    <script>
        ...
        const createForm = id => {
            ...
            f.setAttribute('action',`/admin/circuits/${id}`);
