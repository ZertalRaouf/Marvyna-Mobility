            ...
            <ul class="navbar-nav text-center ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link text-orange" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <img src="{{$u->image_url}}" alt="user" height="40" style="border-radius: 50%">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right border-0 py-0 shadow-sm mt-0 mt-lg-3" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item py-3" href="{{route('user.profile')}}"><i class="fas fa-user text-orange mr-4"></i>Mon profil</a>
                        <div class="dropdown-divider my-0"></div>
                        <a class="dropdown-item py-3" href="{{route('user.settings')}}"><i class="fas fa-cog text-orange mr-4"></i>Paramètres du compte</a>
                        <div class="dropdown-divider my-0"></div>
                        <a class="dropdown-item py-3" href="{{route('user.logout')}}"><i class="fas fa-sign-out-alt text-orange mr-4"></i>Déconnexion</a>
                    </div>
                </li>
